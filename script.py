...
def patch_blarc(aspect_ratio, HUD_pos, unpacked_folder, expiremental_menu):
    ...
    if aspect_ratio >= 16/9:
        ...
        patch_blyt('GameSplashScreen_00', 'P_pict_DK', 'scale_x', 1/s1)
        patch_blyt('GameSplashScreen_00', 'P_pict_DK', 'scale_y', 1/s1)
...
# fix game confimration (controller, exit)
        ...
        if HUD_pos == 'corner':
            ...
            x_layout_map = {
                ...
                'PaCamera_00': ['T_1P_Text', 'P_RightArrow_1P', 'P_LeftArrow_1P', 'P_camera_1P',
                                'T_2P_Text', 'P_RightArrow_2P', 'P_LeftArrow_2P', 'P_camera_2P'],
            ...
            # Incorporate old HUD fix logic here for GameLevelHUD_00 elements inside HUD_00
