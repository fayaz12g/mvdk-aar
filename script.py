...
def patch_blarc(aspect_ratio, HUD_pos, unpacked_folder, expiremental_menu):
    ...
    if aspect_ratio >= 16/9:
        ...
        patch_anim('GameLevelSelect_00', 'GameLevelSelect_00_ModeChangeIn', int(do_specific_math(520, aspect_ratio)), s1)
        patch_anim('GameLevelSelect_00', 'GameLevelSelect_00_ModeChangeOut', int(do_specific_math(520, aspect_ratio)), s1)
