...
def patch_blarc(aspect_ratio, HUD_pos, unpacked_folder, expiremental_menu):
    ...
    splash1 = os.path.join(unpacked_folder, "Layout", f"GameSplashScren_00.Nin_NX_NVN", "blyt", f"GameSplashScren_00.bflyt")
    splash2 = os.path.join(unpacked_folder, "Layout", f"Menu.Product.100.Nin_NX_NVN.Nin_NX_NVN", "blyt", f"GameSplashScren_00.bflyt")
    add_aar_tag(splash1)
    add_aar_tag(splash2)
