...
def patch_blarc(aspect_ratio, HUD_pos, unpacked_folder, expiremental_menu):
    ...
    if aspect_ratio >= 16/9:
        ...
        patch_blyt('GameLevelWin_00', 'L_World', 'shift_x', do_some_math(-50, aspect_ratio))
        ...
        patch_blyt('GameLevelHUD_00', 'L_Lives', 'shift_x', do_special_math(90, aspect_ratio))
        ...
        patch_blyt('GameSplashScreen_00', 'P_BG_Gray', 'scale_y', 1.5/s1)
        patch_blyt('GameSplashScreen_00', 'P_BG_Stars', 'scale_x', 1.5/s1)
        patch_blyt('GameSplashScreen_00', 'P_BG_Stars', 'scale_y', 1.5/s1)
        patch_blyt('GameSplashScreen_00', 'P_BG_Gradient', 'scale_x', 1.5/s1)
        patch_blyt('GameSplashScreen_00', 'P_BG_Gradient', 'scale_y', 1.5/s1)
        ...
        patch_blyt('GameSplashScreen_00', 'P_pict_Mario', 'shift_x', do_some_math(-620, aspect_ratio))
        patch_blyt('GameSplashScreen_00', 'P_pict_DK', 'shift_x', do_some_math(620, aspect_ratio))
